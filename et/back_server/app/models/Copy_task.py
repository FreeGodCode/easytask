...
class EtTask(db.Model):
    ...
    status = db.Column(db.Integer, server_default=db.FetchedValue(), info='任务状态 1：下架 2：上架')
...
class EtTasksVerify(db.Model):
    ...
    task_id = db.Column(db.Integer, index=True, server_default=db.FetchedValue(), info='任务ID')
